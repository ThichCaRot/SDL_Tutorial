...
//	if (!gSpriteSheetTexture.loadFromFile("foi.png"))
//	{
...
//			// Delay time per frame (in milliseconds)
...
//
//				++countedFrames;
//				float currentFPS = countedFrames / ((SDL_GetTicks() - frameStart) / 1000.0f);
...
//				std::string fpsText = "FPS: " + std::to_string((int)averageFPS);
...
//
//				// Delay if needed to maintain the desired frame rate
